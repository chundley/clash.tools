...
#### Verify hostname is siftrock-app[n]
...
````
127.0.0.1       localhost
127.0.1.1       siftrock-app[n] siftrock-app[n]
````
...
`git clone git@github.com:chundley/siftrock-app.git`
...
`$ cd /root/github/siftrock-app/bin`
...
# start app
/var/node/siftrock-app/bin/start-prod.sh
